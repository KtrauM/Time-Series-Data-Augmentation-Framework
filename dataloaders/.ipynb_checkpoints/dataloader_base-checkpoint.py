...
class BASE_DATA():
    ...
    def __init__(self, args):
        ...
        window_save_path = os.path.join(self.window_save_path,"Model={}-DataSet={}-ChannelAug={}-RndAugP={}-Mixup_Alpha={}-MaxRndAugCnt={}-MixupP={}-Predef={}".format(args.model_type, args.data_name, args.difference, args.p['argv'], args.mixup_lambda, args.max_randaug_cnt, args.mixup_p, args.predef_rndaug))
