...
class BASE_DATA():
    ...
    def __init__(self, args):
        ...
        window_save_path = os.path.join(self.window_save_path,"{}-chnlaug{}-rndaug{}-mixup{}-rndaugcnt{}".format(self.data_name, args.difference, args.p['jitter'], args.mixup_lambda, args.max_randaug_cnt))
